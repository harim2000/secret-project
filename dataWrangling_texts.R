...
both_texts <- read.csv("data/message_data_other.csv", encoding = 'UTF-8')

num_texts <- nrow(both_texts)

both_texts$Date <- as.POSIXct(both_texts$Date, format = "%A, %b %d %Y, %H:%M")
...
harim_texts <- filter(both_texts, Received !='Yes')
betsy_texts <- filter(both_texts, Received  == 'Yes')
...
harim_texts_noemoji <- filter(both_texts_noemoji, Received !='Yes')
betsy_texts_noemoji <- filter(both_texts, Received =='Yes')
...
texts_by_day_both$Date <- as.POSIXct(texts_by_day_both$Date, format = "%A, %b %d %Y, %H:%M")
...
texts_by_day_harim$Date <-  as.POSIXct(texts_by_day_harim$Date, format = "%A, %b %d %Y, %H:%M")
...
texts_by_day_betsy$Date <-  as.POSIXct(texts_by_day_betsy$Date, format = "%A, %b %d %Y, %H:%M")
...
heart_texts$Date <- as.POSIXct(heart_texts$Date, format = "%A, %b %d %Y, %H:%M")
...
ily_texts$Date <- as.POSIXct(ily_texts$Date, format = "%A, %b %d %Y, %H:%M")
...
both_texts$hour <- as.POSIXlt(both_texts$Date)$hour
...
all_texts <- both_texts %>% select(Date, Received)
...
export(both_texts_over_time_p, "images/text/both_texts.png")
...
export(harim_texts_over_time_p, "images/text/harim_texts.png")
...
export(betsy_texts_over_time_p, "images/text/betsy_texts.png")
#heart graphs===================================================================
...
export(heart_texts_time_p, "images/text/heart_texts.png")
...
export(ily_texts_time_p, "images/text/ily_texts.png")
...
export(top_emoji_p, "images/text/top_emoji.png")
...
export(top_harim_emoji_p, "images/text/top_emoji_harim.png")
...
export(top_betsy_emoji_p, "images/text/top_emoji_betsy.png")
...
export(percentage_hehe_p, "images/text/percentage_hehe.png")
...
export(percentage_haha_lol_p, "images/text/percentage_haha.png")
...
export(text_heatmap_p, "images/text/text_heatmap.png")
...
export(sent_by_hour_p, "images/text/sent_by_hour.png")
